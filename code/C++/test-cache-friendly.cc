...
void test_cache_aware_matrix (void) {
    ...
    std::vector<CS> col0_starts = {CS(0,0), CS(1,2),  CS(2,4),  CS(3,6)};
    std::vector<CS> col1_starts = {CS(0,8), CS(1,10), CS(2,12), CS(3,14)};
    std::vector<std::vector<CS>> col_starts = {col0_starts, col1_starts};
